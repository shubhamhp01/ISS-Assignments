						...
						<form method="post" action="register" class="register-form"
							...
							<div class="form-group">
								<label for="pass"><i class="zmdi zmdi-lock"></i></label> <input
									type="password" value="Sp@12345" name="pass" id="pass" placeholder="Password"  required="required" />
							</div>
							<div class="form-group">
								<label for="re-pass"><i class="zmdi zmdi-lock-outline"></i></label>
								<input type="password" value="Sp@12345" name="re_pass" id="re_pass"
...
<script type="text/javascript">
	...
	if(status=="invlaidUpwd"){
		swal("Please enter password","error");
	}
	if(status=="invlaidConfirmPassword"){
		swal("Passwords do not match","error");
	}
	if(status=="pwdnotMatch"){
		swal("Please enter correct password format. Must contain 8 characters, 1 digit, 1 lowercase, 1 uppercase and 1 special character","error");
	}
